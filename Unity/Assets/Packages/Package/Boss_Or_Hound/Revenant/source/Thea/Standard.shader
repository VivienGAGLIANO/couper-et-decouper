...
void main()
{
    ...
    u_xlat16_45 = u_xlat16_43 * _OcclusionStrength + u_xlat16_45;
    ...
    if(u_xlatb47){
        ...
        if(u_xlatb47){
            ...
            u_xlat6.xyz = u_xlat16_4.xyz * vec3(u_xlat16_47);
        ...
        u_xlat16_4 = textureLod(unity_SpecCube1, u_xlat6.xyz, u_xlat16_46);
        ...
        u_xlat16_5.xyz = u_xlat16_10.xxx * u_xlat16_5.xyz + (-u_xlat16_12.xyz);
        u_xlat24.xyz = unity_SpecCube0_BoxMin.www * u_xlat16_5.xyz + u_xlat16_12.xyz;
...
void main()
{
    ...
    if(u_xlatb45){
        ...
        u_xlat7.xyz = vec3(u_xlat16_45) * u_xlat16_5.xyz;
    ...
    u_xlat16_6 = textureLod(unity_SpecCube0, u_xlat7.xyz, u_xlat16_50);
    ...
    if(u_xlatb45){
        ...
        u_xlat16_7.xyz = u_xlat16_12.xxx * u_xlat16_6.xyz + (-u_xlat16_13.xyz);
        u_xlat27.xyz = unity_SpecCube0_BoxMin.www * u_xlat16_7.xyz + u_xlat16_13.xyz;
    ...
    u_xlat16_57 = u_xlat16_57 * u_xlat4 + -0.5;
    ...
    u_xlat30 = u_xlat1.x * u_xlat16_57;
    u_xlat16.x = u_xlat4 * u_xlat4;
    ...
    u_xlat16_13.xzw = u_xlat16_19.xyz * vec3(u_xlat16_48) + u_xlat16_13.xzw;
    u_xlat1.xyz = u_xlat0.xxx * _LightColor0.xyz;
...
void main()
{
    ...
    u_xlat16_43 = texture(_ShadowMapTexture, u_xlat5.xy).x;
    u_xlat16_42 = (-u_xlat16_43) + 1.0;
    u_xlat16_42 = u_xlat40 * u_xlat16_42 + u_xlat16_43;
    u_xlat16_40 = texture(_OcclusionMap, vs_TEXCOORD0.xy).y;
    u_xlat16_7.x = (-_OcclusionStrength) + 1.0;
    u_xlat16_7.x = u_xlat16_40 * _OcclusionStrength + u_xlat16_7.x;
    ...
    if(u_xlatb43){
        ...
        u_xlat5.xyz = vec3(u_xlat16_43) * u_xlat16_20.xyz;
    ...
    u_xlat16_11.xyz = u_xlat16_5.xyz * vec3(u_xlat16_47);
#ifdef UNITY_ADRENO_ES3
    ...
    if(u_xlatb43){
        ...
        if(u_xlatb43){
            u_xlat16_43 = dot(u_xlat16_20.xyz, u_xlat16_20.xyz);
            u_xlat16_43 = inversesqrt(u_xlat16_43);
            u_xlat6.xyz = vec3(u_xlat16_43) * u_xlat16_20.xyz;
        ...
        u_xlat16_4 = textureLod(unity_SpecCube1, u_xlat4.xyz, u_xlat16_42);
        ...
        u_xlat16_20.xyz = u_xlat16_4.xyz * vec3(u_xlat16_42);
        u_xlat16_4.xyz = vec3(u_xlat16_47) * u_xlat16_5.xyz + (-u_xlat16_20.xyz);
        u_xlat11.xyz = unity_SpecCube0_BoxMin.www * u_xlat16_4.xyz + u_xlat16_20.xyz;
    ...
    u_xlat4.x = abs(u_xlat39) * u_xlat27 + u_xlat14;
...
void main()
{
    ...
    u_xlat16_45 = (-u_xlat16_5.x) + 1.0;
    u_xlat16_45 = u_xlat46 * u_xlat16_45 + u_xlat16_5.x;
    u_xlat16_46 = texture(_OcclusionMap, vs_TEXCOORD0.xy).y;
    u_xlat16_7.x = (-_OcclusionStrength) + 1.0;
    u_xlat16_7.x = u_xlat16_46 * _OcclusionStrength + u_xlat16_7.x;
    ...
    u_xlat16_6 = textureLod(unity_SpecCube0, u_xlat6.xyz, u_xlat16_45);
    ...
    if(u_xlatb42){
        ...
        u_xlat16_10 = textureLod(unity_SpecCube1, u_xlat4.xyz, u_xlat16_45);
        u_xlat16_45 = u_xlat16_10.w + -1.0;
        u_xlat16_45 = unity_SpecCube1_HDR.w * u_xlat16_45 + 1.0;
        u_xlat16_45 = u_xlat16_45 * unity_SpecCube1_HDR.x;
        u_xlat16_21.xyz = u_xlat16_10.xyz * vec3(u_xlat16_45);
        u_xlat16_4.xyz = vec3(u_xlat16_50) * u_xlat16_6.xyz + (-u_xlat16_21.xyz);
...
void main()
{
    ...
    u_xlat16_2.xyz = vec3(u_xlat16_47) * u_xlat16_7.xyz + u_xlat16_2.xyz;
    u_xlat0.xyz = u_xlat16_3.xyz * u_xlat16_2.xyz + u_xlat0.xyz;
    u_xlat39 = vs_TEXCOORD1.w * unity_FogParams.z + unity_FogParams.w;
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat16_1.xyz * vec3(u_xlat16_22);
    u_xlat0.xyz = u_xlat16_5.xyz * u_xlat16_4.xyz + u_xlat2.xyz;
    u_xlat18 = vs_TEXCOORD1.w * unity_FogParams.z + unity_FogParams.w;
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_2.xyz * vec3(u_xlat16_33);
    u_xlat0.xyz = u_xlat16_7.xyz * u_xlat16_6.xyz + u_xlat0.xzw;
    u_xlat27 = vs_TEXCOORD1.w * unity_FogParams.z + unity_FogParams.w;
#ifdef UNITY_ADRENO_ES3
    u_xlat27 = min(max(u_xlat27, 0.0), 1.0);
#else
    u_xlat27 = clamp(u_xlat27, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat0 = (-u_xlat0.zzzz) + unity_4LightPosZ0;
    u_xlat2 = u_xlat5 * u_xlat2.xxxx + u_xlat4;
